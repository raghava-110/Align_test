...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterContent" runat="server">
    <div class="pop-wrapper" id='inviteUserContentPopup' data-bind='showProgress: showProgress'>
        <div class="pop-content overflow-list">
            <h2 style="margin-bottom: 13px !important;">Invite Users
            </h2>
            <p data-bind="visible:companyIsInTrialAndRequiresDemo"><em>Invitations will not be sent until this account subscribes. Invite users now so you can begin assigning them work.</em></p>
            <p data-bind="visible:onlyChargeForAdmins">
                Your pricing plan only charges for Administrators.<br />
                Invitations to Users without Administrator checked will not be charged.
            </p>
                ...
                <div class="k-listview-content">
                    <ul class="full form no-style no-margin-bottom" data-uid="eeee3e21-de9a-4535-bb2c-696c9399c14d" role="listitem" style="margin-bottom: 0;">
                        <li class="no-margin-bottom">
                            <div class="flex newuseremailinput margin-right-15per float-left">
                                <span class="label newuseremaillabel newuserdialoglabel float-left">Email</span>

                            </div>
                            <div class="flex center" style="justify-content: center;">
                                <span class="label newuserdialoglabel">Admin</span>
            ...
            <div class="invite-list" id="inviteUserList"
                data-role="listview"
                data-template="templateInviteUserEntry"
                data-bind="source: dsUserInvites">
            </div>

            <button id="inviteUserContentPopup_button_addInvite" class="small button btn-ghost" data-bind="click: clickAddInvite"><span class="icon ico-plus-circle margin-right-less"></span>Add Email</button><br /><span class="smaller-font">(or press the Return/Enter key to quickly add more users)</span>

            <label class="multiselect-no-tags" data-bind="visible: showAddToHuddles">
                <div class="label margin-top" title="Select one or more Huddles...&#013;&#010;The invited User(s) will be added to the Huddle as a member.">
                ...
                <ul class="full form no-style">
                    ...
                    <li>
                        <div class="flex promo-code">
                            <input id="inviteUserContentPopup_input_promoCode" class="input" type="text" data-bind="value: promoCode.code" />
                            <button id="inviteUserContentPopup_button_apply" class="small button gray" data-bind="text: promoCode.buttonCaption, click: promoCode.clickApply">Apply</button>
                        </div>
                    </li>
                    <li>
    ...
    <script type="text/javascript" src="/js/Generated/InviteUserDialog.js"></script>
    <!--#include file="/Templates/templateInviteUserEntry.template.html"-->
